...
from scripts.dicom_validator.spec_reader.condition import (
    Condition,
    ConditionType,
    ConditionOperator,
)
from scripts.dicom_validator.spec_reader.condition_parser import ConditionParser
from scripts.dicom_validator.spec_reader.enum_parser import EnumParser
from scripts.dicom_validator.spec_reader.spec_reader import (
    SpecReader,
