...
from scripts import dicom_validator
...
file_path = 'C:/Users/graf35/Desktop/Coding/ecg-uploader/data/xml/berlin_demo.xml'
output = 'C:/Users/graf35/Desktop/Coding/ecg-uploader/data/dicom/test2.dcm'
csv_annotations_path = "./annotations.csv"
ecgdata, metadata = extract_ecg_and_metadata.extract_data(file_path,1)
output_file_path = load_to_dicom.create_dicom_ecg(ecgdata, metadata, output, DEFAULT_ANNOTATIONS,1)
if output_file_path:
    validate_dicom.validate_dicom_file(output_file_path, 1)
pass